...
describe('collection components', () => {
  ...
  it('parseComponents, includeBundledOnly=true', () => {
    ...
    expect(collection.moduleFiles[0].cmpMeta.tagNameMeta).toBe('cmp-a');
    expect(collection.moduleFiles[1].cmpMeta.tagNameMeta).toBe('cmp-c');
    expect(collection.moduleFiles[2].cmpMeta.tagNameMeta).toBe('cmp-e');
  });
